          ...
          <div className="flex min-h-full items-stretch justify-center text-center md:items-center md:px-2 lg:px-4">
            ...
            <el-dialog-panel className="flex w-full transform text-left text-base transition data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in md:my-8 md:max-w-2xl md:px-4 data-closed:md:translate-y-0 data-closed:md:scale-95 lg:max-w-2xl">
              ...
              <div className="relative flex w-full items-center overflow-hidden bg-white px-3 pt-3 pb-3 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-5">  
                ...
                {/* close button */}
                <button type="button" command="close" commandfor="modal" className="absolute top-4 right-4 text-gray-400 hover:text-gray-500 sm:top-8 sm:right-6 md:top-6 md:right-6 lg:top-6 lg:right-4">
                  <span className="sr-only">Close</span>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" data-slot="icon" aria-hidden="true" className="size-5">
...
const Shoe_Card = ({ name, color, price, imgSrc }) => {
    if(imgSrc == null) imgSrc = "https://www.superkicks.in/cdn/shop/files/1_23_63d4bcad-2f4f-4dff-8606-1b9687a04aa5.png?v=1754314154"
    return (
        <div className="border rounded-lg overflow-hidden shadow-md hover:shadow-lg transition lg:h-100 w-100">
            <img 
                src={imgSrc} 
                alt={`${name} shoe`} 
                className="aspect-square w-full object-cover bg-gray-100 lg:h-60 w-100" 
            />
            ...
            <div className="p-3">
                ...
                <h3 className="text-2xl text-black text-left">{name}: Name</h3>
                <p className="text-gray-400 text-sm text-left mt-1 mb-1">{color} : color</p>
                
                <p className="mt-2 text-left font-medium">₹{price} 500/-</p>
            </div>
        </div>
    );
};
